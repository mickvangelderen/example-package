[![Build Status](https://travis-ci.org/mickvangelderen/example-package.svg?branch=node4)](https://travis-ci.org/mickvangelderen/example-package)
...
```bash
npm install @mickvangelderen/example-package-node4
```
